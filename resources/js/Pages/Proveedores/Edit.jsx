...
export default function Edit({ proveedor, marcas }) {
    const marcasActuales = proveedor.marcas?.map(
        (marca) => Number(marca.id_marca)
    ) ?? [];
        ...
        >
            ...
            >
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        Selecciona las marcas que comercializa este proveedor.
                    </p>
